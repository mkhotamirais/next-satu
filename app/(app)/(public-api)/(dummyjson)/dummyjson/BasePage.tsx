  ...
  return (
    <div className="">
      ...
      <div className="space-y-4 mt-8">
        <div>
          <p>Paginasi Input</p>
          <PaginationInput totalPages={totalPages} currentPage={page} path="/dummyjson/page" />
        </div>
        <div>
          <p>Paginasi Number</p>
          <PaginationNumber totalPages={totalPages} currentPage={page} path="/dummyjson/page" />
        </div>
        <div>
          <p>Paginasi Dots</p>
          <PaginationDots totalPages={totalPages} currentPage={page} path="/dummyjson/page" />
        </div>
      </div>
    </div>
  );
