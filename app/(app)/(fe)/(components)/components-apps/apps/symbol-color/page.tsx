...
export default function SymbolColor() {
  ...
  return (
    <section>
      <h2 className="h2">Symbol Color</h2>
      <div className="font-poppins w-full h-screen flex flex-col items-center p-3 sm:px-12 md:px-20 lg:px-48 xl:px-72 justify-center">
        <input
          value={search}
          type="search"
        ...
        <div className={`${colorData.bgHex} h-[90vh] relative rounded-xl size-full flex flex-col p-1`}>
              ...
              {symbolColorMenus
                ...
                .map((item) => (
                  <motion.button
                    ...
                    animate={{ backgroundColor: active === `${item.hex}` ? `${item.hex}` : "#aaaaaa" }}
          ...
          <div className="h-1/2 rounded-xl bg-gray-200 flex flex-col">
